// Loaded all data from API without Calling again and again
...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${product.image}></img>
      ...
      <h4 style="font-weight: 600;"> Avg. Rating: ${product.rating.rate}</h4>
      <p style="font-weight: 600;"> ${product.rating.count} People Rated this Product </p>
...
// Getting Price , Total-tax, delivery and Total Value
...
const updateTaxAndCharge = () => {
  ...
  // this condition will apply for if product price bigger than 200
  if (priceConverted > 200) {
    setInnerText("delivery-charge", 30);
    setInnerText("total-tax", priceConverted * 0.2);
   
  }
  // this condition will apply for if product price bigger than 400
  if (priceConverted > 400) {
    setInnerText("delivery-charge", 50);
    setInnerText("total-tax", priceConverted * 0.3);
    
  }
  // this condition will apply for if product price bigger than 500
